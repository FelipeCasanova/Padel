...
{
    public class CrearEquipoEventHandle : INotificationHandler<CrearEquipoEvent>
    {
        ...
        public CrearEquipoEventHandle(INHibernateRepository<Operacion> operacionRepository, INHibernateRepository<Usuario> usuarioRepository, INHibernateRepository<Equipo> equipoRepository)
        {
